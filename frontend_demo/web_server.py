...
MODEL_DATASETS = {
    'GCN': ['Cora', 'Citeseer', 'Pubmed', 'Reddit', 'Amazon', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'ogbn-arxiv', 'ogbn-products'],
    'GAT': ['Cora', 'Citeseer', 'Pubmed'],
    'GraphSAGE': ['Cora', 'Citeseer', 'Pubmed', 'Reddit', 'Amazon', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'ogbn-arxiv', 'ogbn-products'],
    'ChebNet': ['Cora', 'Citeseer', 'Pubmed'],
    'ChebNet2': ['Cora', 'Citeseer', 'Pubmed'],
    'GCN2': ['Cora', 'Citeseer', 'Pubmed'],
    'GPRGNN': ['Cora', 'Citeseer', 'Pubmed'],
    'SGC': ['Cora', 'Citeseer', 'Pubmed'],
    'BernNet': ['Cora', 'Citeseer', 'Pubmed'],
    'EvenNet': ['Cora', 'Citeseer', 'Pubmed'],
    'APPNP': ['Cora', 'Citeseer', 'Pubmed', 'Reddit', 'Amazon', 'Computers', 'Photo', 'Chameleon', 'Squirrel', 'ogbn-arxiv', 'ogbn-products'],
    'ClusterGCN': ['Cora', 'Citeseer', 'Pubmed', 'Reddit'],
    'DGI': ['Cora', 'Citeseer', 'Pubmed'],
    'GRACE': ['Cora', 'Citeseer', 'Pubmed'],
    'MVGRL': ['Cora', 'Citeseer', 'Pubmed'],
    'RecSys': ['ml-100k', 'ml-1m', 'yelp2018'],
    'SASRec': ['Wikipedia', 'Reddit', 'mooc', 'lastfm'],
    'SchNet': ['QM9'],
    'SphereNet': ['QM9'],
    'DimeNet': ['QM9'],
    'UniMol': ['bace'],
    ...
    'OptBasisGNN': ['QM9'],
    'EGNN': ['QM9'],
    'SGFormer': ['Cora', 'Citeseer', 'Pubmed'],
    'Craft': ['Cora', 'Citeseer', 'Pubmed'],
    'Graphormer': ['Cora', 'Citeseer', 'Pubmed'],
    'GraphMixer': ['Cora', 'Citeseer', 'Pubmed'],
    'PolyFormer': ['Cora', 'Citeseer', 'Pubmed'],
    'PolyGCL': ['Cora', 'Citeseer', 'Pubmed'],
    'SGNHN': ['Cora', 'Citeseer', 'Pubmed'],
    'DyGFormer': ['Cora', 'Citeseer', 'Pubmed'],
    'DyRep': ['Cora', 'Citeseer', 'Pubmed'],
    'DyRep_v2': ['Cora', 'Citeseer', 'Pubmed'],
    'Jodie': ['Cora', 'Citeseer', 'Pubmed'],
    'LinkPred': ['Cora', 'Citeseer', 'Pubmed'],
    'NAGPhormer': ['Cora', 'Citeseer', 'Pubmed'],
    'TGN': ['Cora', 'Citeseer', 'Pubmed'],
    'TGN_v2': ['Cora', 'Citeseer', 'Pubmed'],
    'GCN_ACL': ['Cora', 'Citeseer', 'Pubmed'],
}
