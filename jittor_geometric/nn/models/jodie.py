...
JodieMessageStoreType = Dict[int, Tuple[jt.Var, jt.Var, jt.Var, jt.Var]]
import numpy as np
...
class JodieMemory(nn.Module):
    ...
    def _compute_msg(self, n_id: jt.Var, msg_store: JodieMessageStoreType,
                     msg_module: Callable, is_src = True):
